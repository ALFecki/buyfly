...
//    @field:BsonProperty("name") @param:BsonProperty("name") override var name: String,
    ...
    companion object {
        fun fromAircraft(flight: Flight) : MongoFlight {
            return MongoFlight(flight.number, flight.departure, flight.arrival, flight.date, flight.aircraft)
        }

        fun toAircraft(mongoFlight: MongoFlight) : Flight {
            return Flight(mongoFlight.number, mongoFlight.departure, mongoFlight.arrival, mongoFlight.date, mongoFlight.aircraft)
        }
    }
}